    ...
    <AppBar className='navbar' position='static'>
      <Toolbar>
        ...
        <div className={ `link-wrapper ${ isResponsive ? 'responsive' : '' }` }>
          <Link to="/products" className='link' onClick={() => { setIsResponsive(false) }}><Button className='link-btn'>Products</Button></Link>
          ...
          <span className='link' onClick={() => { setIsResponsive(false) }}><Button className='link-btn' color="inherit">Logout</Button></span>
        </div>
